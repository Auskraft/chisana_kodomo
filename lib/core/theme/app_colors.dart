...
class AppColors extends ThemeExtension<AppColors> {
  ...
  // ── Производные мягкие поверхности ──────────────────────────────────────
  // Считаются из ролей темы (без хардкода): выбрал тему — всё тонируется само.
  // Никакого «голого» белого: карточки/панели/чипы берут лёгкий оттенок темы.

  /// Карточка/панель: мягкий оттенок темы (не белый, не яркий) — плашки,
  /// карточки игр и уровней, панели, попапы.
  Color get card => Color.lerp(surface, primary, 0.10)!;

  /// Очень лёгкий чип/пилюля (HUD поверх игрового фона) — едва тонирован,
  /// чтобы не спорить с фоном.
  Color get chip => Color.lerp(surface, primary, 0.05)!;
